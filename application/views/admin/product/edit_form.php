				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url(" admin/product/edit") ?>" method="post"
							...
							<div class="form-group">
								<label for="name">Idol*</label>
								<input class="form-control <?php echo form_error('idol') ? 'is-invalid':'' ?>"
								 type="text" name="idol" placeholder="Idol name" value="<?php echo $product->idol ?>" />
								<div class="invalid-feedback">
									<?php echo form_error('idol') ?>
								</div>
							</div>
